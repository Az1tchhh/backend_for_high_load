...
INSTALLED_APPS = [
    ...
    'apps.users.avatars.apps.AvatarsConfig',
    'apps.orders.apps.OrdersConfig',
    'apps.warehouse.apps.WarehouseConfig',
    'apps.pickup_point.apps.PickupPointConfig',
    'apps.country.apps.CountryConfig',
    'apps.users.personal_info.apps.PersonalInfoConfig',
    'apps.wallets.apps.WalletsConfig',
]

NINJA_EXTRA = {
    'INJECTOR_MODULES': [
        'apps.orders.modules.OrderModule',
    ]
}
